...
crate::wrapper! {
    ...
    match fn {
        copy => |ptr| ffi::g_bookmark_file_copy(ptr),
...
impl BookmarkFile {
    ...
    pub fn add_application(&self, uri: &str, name: Option<&str>, exec: Option<&str>) {
        unsafe {
    ...
    pub fn add_group(&self, uri: &str, group: &str) {
        unsafe {
    ...
    pub fn load_from_data(&self, data: &[u8]) -> Result<(), crate::Error> {
    ...
    pub fn move_item(&self, old_uri: &str, new_uri: Option<&str>) -> Result<(), crate::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
    ...
    pub fn remove_application(&self, uri: &str, name: &str) -> Result<(), crate::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
    ...
    pub fn remove_group(&self, uri: &str, group: &str) -> Result<(), crate::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
    ...
    pub fn remove_item(&self, uri: &str) -> Result<(), crate::Error> {
        unsafe {
            let mut error = std::ptr::null_mut();
    ...
    pub fn set_added(&self, uri: &str, added: libc::time_t) {
        unsafe {
            ffi::g_bookmark_file_set_added(
                mut_override(self.to_glib_none().0),
                uri.to_glib_none().0,
                added,
            );
    ...
    pub fn set_added_date_time(&self, uri: &str, added: &DateTime) {
        unsafe {
    ...
    pub fn set_description(&self, uri: Option<&str>, description: &str) {
        unsafe {
    ...
    pub fn set_groups(&self, uri: &str, groups: &[&str]) {
    ...
    pub fn set_icon(&self, uri: &str, href: Option<&str>, mime_type: &str) {
        unsafe {
    ...
    pub fn set_is_private(&self, uri: &str, is_private: bool) {
        unsafe {
    ...
    pub fn set_mime_type(&self, uri: &str, mime_type: &str) {
        unsafe {
    ...
    pub fn set_modified(&self, uri: &str, modified: libc::time_t) {
        unsafe {
    ...
    pub fn set_modified_date_time(&self, uri: &str, modified: &DateTime) {
        unsafe {
    ...
    pub fn set_title(&self, uri: Option<&str>, title: &str) {
        unsafe {
    ...
    pub fn set_visited(&self, uri: &str, visited: libc::time_t) {
        unsafe {
    ...
    pub fn set_visited_date_time(&self, uri: &str, visited: &DateTime) {
        unsafe {

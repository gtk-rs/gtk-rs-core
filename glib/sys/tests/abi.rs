...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(guint) G_REGEX_NEWLINE_RESERVED1", "4194304"),
    ...
    ("(guint) G_TEST_SUBPROCESS_INHERIT_DESCRIPTORS", "8"),
    ...
    ("(gint) G_UNICODE_BREAK_UNAMBIGUOUS_HYPHEN", "48"),
    ...
    ("(gint) G_UNICODE_SCRIPT_BERIA_ERFE", "175"),
    ...
    ("(gint) G_UNICODE_SCRIPT_SIDETIC", "172"),
    ...
    ("(gint) G_UNICODE_SCRIPT_TAI_YO", "174"),
    ...
    ("(gint) G_UNICODE_SCRIPT_TOLONG_SIKI", "173"),

...
int main() {
    ...
    PRINT_CONSTANT((guint) G_REGEX_NEWLINE_RESERVED1);
    ...
    PRINT_CONSTANT((guint) G_TEST_SUBPROCESS_INHERIT_DESCRIPTORS);
    ...
    PRINT_CONSTANT((gint) G_UNICODE_BREAK_UNAMBIGUOUS_HYPHEN);
    ...
    PRINT_CONSTANT((gint) G_UNICODE_SCRIPT_BERIA_ERFE);
    ...
    PRINT_CONSTANT((gint) G_UNICODE_SCRIPT_SIDETIC);
    ...
    PRINT_CONSTANT((gint) G_UNICODE_SCRIPT_TAI_YO);
    ...
    PRINT_CONSTANT((gint) G_UNICODE_SCRIPT_TOLONG_SIKI);
    ...
    PRINT_CONSTANT((gint) G_USER_DIRECTORY_PROJECTS);

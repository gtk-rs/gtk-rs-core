...
int main() {
    ...
    PRINT_CONSTANT((gint) G_ECN_ECT_0);
    PRINT_CONSTANT((gint) G_ECN_ECT_1);
    PRINT_CONSTANT((gint) G_ECN_ECT_CE);
    PRINT_CONSTANT((gint) G_ECN_NO_ECN);
    ...
    PRINT_CONSTANT((guint) G_IO_MODULE_SCOPE_BLOCK_DUPLICATES);
    ...
    PRINT_CONSTANT((guint) G_TLS_CERTIFICATE_REQUEST_NONE);
    ...
    PRINT_CONSTANT((guint) G_TLS_DATABASE_LOOKUP_KEYPAIR);
    PRINT_CONSTANT((guint) G_TLS_DATABASE_LOOKUP_NONE);

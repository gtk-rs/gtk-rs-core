...
pub const NONE_DBUS_OBJECT_MANAGER: Option<&DBusObjectManager> = None;

pub trait DBusObjectManagerExt: 'static {
    #[doc(alias = "g_dbus_object_manager_get_interface")]
    #[doc(alias = "get_interface")]
    fn interface(&self, object_path: &str, interface_name: &str) -> DBusInterface;

    #[doc(alias = "g_dbus_object_manager_get_object")]
    #[doc(alias = "get_object")]
    fn object(&self, object_path: &str) -> DBusObject;

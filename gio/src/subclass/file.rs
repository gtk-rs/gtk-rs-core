...
use glib::{
    prelude::*, subclass::prelude::*, thread_guard, translate::*, Error, GString, Interface, Object,
};

use crate::{
    ffi, file::FileAttributeTypeValue, AsyncResult, Cancellable, DriveStartFlags, File,
    FileAttributeInfoList, FileAttributeType, FileCopyFlags, FileCreateFlags, FileEnumerator,
    FileIOStream, FileInfo, FileInputStream, FileMeasureFlags, FileMonitor, FileMonitorFlags,
    FileOutputStream, FileQueryInfoFlags, IOErrorEnum, Mount, MountMountFlags, MountOperation,
    MountUnmountFlags, Task,
};

use libc::{c_char, c_uint};

use std::{boxed::Box as Box_, path::PathBuf};
...
pub trait FileImpl: ObjectImpl + ObjectSubclass<Type: IsA<File>> {
    ...
    fn resolve_relative_path(&self, relative_path: &str) -> File {
    ...
    fn set_attribute(
        ...
        value: FileAttributeTypeValue<glib::ffi::gpointer>,
        flags: FileQueryInfoFlags,
        cancellable: Option<&impl IsA<Cancellable>>,
    ) -> Result<(), Error> {
        self.parent_set_attribute(attribute, type_, value, flags, cancellable)
    }
    ...
    fn mount_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
    ...
    fn unmount_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
    ...
    fn eject_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        cancellable: Option<&impl IsA<Cancellable>>,
        callback: Option<P>,
    ...
    fn mount_enclosing_volume<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountMountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn start_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
    ...
    fn stop_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn unmount_mountable_with_operation<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn eject_mountable_with_operation<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn poll_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        cancellable: Option<&impl IsA<Cancellable>>,
        callback: Option<P>,
    ) {
    ...
    fn measure_disk_usage<P: FnMut(bool, u64, u64, u64) + 'static>(
        &self,
...
pub trait FileImplExt: FileImpl {
    ...
    fn parent_resolve_relative_path(&self, relative_path: &str) -> File {
        unsafe {
            let type_data = Self::type_data();
            let parent_iface =
                type_data.as_ref().parent_interface::<File>() as *const ffi::GFileIface;
    ...
    fn parent_delete(&self, cancellable: Option<&impl IsA<Cancellable>>) -> Result<(), Error> {
        unsafe {
            let type_data = Self::type_data();
            let parent_iface =
                type_data.as_ref().parent_interface::<File>() as *const ffi::GFileIface;
    ...
    fn parent_trash(&self, cancellable: Option<&impl IsA<Cancellable>>) -> Result<(), Error> {
        unsafe {
            let type_data = Self::type_data();
            let parent_iface =
                type_data.as_ref().parent_interface::<File>() as *const ffi::GFileIface;
        ...
        unsafe {
            ...
            if let Some(func) = (*parent_iface).copy {
                let (progress_callback, progress_callback_data) =
                    progress_callback.map_or((None, std::ptr::null_mut()), |progress_callback| {
                        let mut super_callback = progress_callback;
                        unsafe extern "C" fn progress_callback_func<P: FnMut(i64, i64)>(
                            current_num_bytes: i64,
                            total_num_bytes: i64,
                            data: glib::ffi::gpointer,
                        ) {
                            let callback = &mut *(data as *mut P);
                            callback(current_num_bytes, total_num_bytes)
                        }
                        let callback = progress_callback_func::<&mut dyn (FnMut(i64, i64))>;

                        (Some(callback as _), &mut super_callback as *mut _ as *mut _)
                    });
    ...
    fn parent_mount_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountMountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
        ...
        unsafe {
            ...
            let (callback, user_data) = callback.map_or((None, std::ptr::null_mut()), |callback| {
                let super_callback = Box_::new(thread_guard::ThreadGuard::new(callback));

                unsafe extern "C" fn callback_trampoline<
                    P: FnOnce(&Object, &AsyncResult) + 'static,
                >(
                    source_object: *mut glib::gobject_ffi::GObject,
                    res: *mut ffi::GAsyncResult,
                    data: glib::ffi::gpointer,
                ) {
                    let source_object: &Object = &from_glib_borrow(source_object);
                    let res: &AsyncResult = &from_glib_borrow(res);
                    let callback: Box_<thread_guard::ThreadGuard<P>> =
                ...
                (
                    Some(callback as _),
                    Box_::into_raw(super_callback) as *mut _,
                )
            });
    ...
    fn parent_unmount_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        cancellable: Option<&impl IsA<Cancellable>>,
        callback: Option<P>,
        ...
        let (callback, user_data) = callback.map_or((None, std::ptr::null_mut()), |callback| {
            ...
            unsafe extern "C" fn callback_trampoline<P: FnOnce(&Object, &AsyncResult) + 'static>(
                source_object: *mut glib::gobject_ffi::GObject,
                res: *mut ffi::GAsyncResult,
                data: glib::ffi::gpointer,
            ) {
                let source_object: &Object = &from_glib_borrow(source_object);
                let res: &AsyncResult = &from_glib_borrow(res);
                let callback: Box_<thread_guard::ThreadGuard<P>> = Box_::from_raw(data as *mut _);
                let callback: P = callback.into_inner();
                callback(source_object, res);
            }
            let callback = callback_trampoline::<P>;
    ...
    fn parent_eject_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        cancellable: Option<&impl IsA<Cancellable>>,
        callback: Option<P>,
    ...
    fn parent_mount_enclosing_volume<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountMountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
        ...
        unsafe {
            ...
            if let Some(func) = (*parent_iface).mount_enclosing_volume {
                ...
                ffi::g_task_report_new_error(
                    ...
                    IOErrorEnum::domain().into_glib(),
                    IOErrorEnum::NotSupported.into_glib(),
                    "volume doesn’t implement mooooount".to_glib_full(),
                );
            }
        }
    }
    ...
    fn parent_start_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: DriveStartFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn parent_stop_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn parent_unmount_mountable_with_operation<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn parent_eject_mountable_with_operation<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        flags: MountUnmountFlags,
        mount_operation: Option<&MountOperation>,
        cancellable: Option<&impl IsA<Cancellable>>,
    ...
    fn parent_poll_mountable<P: FnOnce(&Object, &AsyncResult) + 'static>(
        &self,
        cancellable: Option<&impl IsA<Cancellable>>,
        callback: Option<P>,
    ) {
    ...
    fn parent_measure_disk_usage<P: FnMut(bool, u64, u64, u64) + 'static>(
        &self,
        flags: FileMeasureFlags,
        cancellable: Option<&impl IsA<Cancellable>>,
        progress_callback: Option<P>,
    ) -> Result<(u64, u64, u64), Error> {
        let (progress_callback, progress_data) =
            progress_callback.map_or((None, std::ptr::null_mut()), |progress_callback| {
                let mut super_callback: Option<P> = Some(progress_callback);
                unsafe extern "C" fn progress_callback_func<
                    P: FnMut(bool, u64, u64, u64) + 'static,
                >(
                    ...
                    let callback = data as *mut Option<P>;
                    if let Some(ref mut callback) = *callback {
                        callback(from_glib(reporting), current_size, num_dirs, num_files)
                    } else {
                        panic!("cannot get closure...")
                    }
                }
                let callback = progress_callback_func::<P>;
    ...
    fn parent_query_exists(&self, cancellable: Option<&impl IsA<Cancellable>>) -> bool {
        unsafe {
            let type_data = Self::type_data();
            let parent_iface =
                type_data.as_ref().parent_interface::<File>() as *const ffi::GFileIface;
...
unsafe impl<T: FileImpl> IsImplementable<T> for File {
    fn interface_init(iface: &mut Interface<Self>) {
        ...
        // TODO: if necessary override the `GFile` implementation of the following vfuncs:
...
unsafe extern "C" fn file_resolve_relative_path<T: FileImpl>(
    ...
    let resolved_path = imp.resolve_relative_path(&GString::from_glib_borrow(relative_path));
...
unsafe extern "C" fn file_get_child_for_display_name<T: FileImpl>(
    ...
    if basename.is_null() {
        if !error.is_null() {
            *error = Error::new::<IOErrorEnum>(IOErrorEnum::InvalidFilename, "Invalid filename")
                .to_glib_full();
        }
...
unsafe extern "C" fn file_make_symbolic_link<T: FileImpl>(
    ...
    let res = imp.make_symbolic_link(
        &GString::from_glib_borrow(symlink_value),
        cancellable.as_ref(),
    );
    match res {
        Ok(_) => true.into_glib(),
...
unsafe extern "C" fn file_copy<T: FileImpl>(
    ...
    let mut progress_callback = progress_callback.map(|callback| {
        move |current_num_bytes, total_num_bytes| unsafe {
    ...
    let res = T::copy(
        ...
        progress_callback
            .as_mut()
            .map(|callback| callback as &mut dyn FnMut(i64, i64)),
    );
    match res {
        Ok(_) => true.into_glib(),
        Err(err) => {
...
unsafe extern "C" fn file_mount_mountable<T: FileImpl>(
    ...
    let callback = callback.map(|callback| {
        move |source_object: &Object, res: &AsyncResult| unsafe {
            callback(
...
unsafe extern "C" fn file_measure_disk_usage<T: FileImpl>(
    ...
    let progress_callback = progress_callback.map(|callback| {
        Box::new(
            move |reporting: bool, current_size: u64, num_dirs: u64, num_files: u64| unsafe {
                callback(
                    reporting.into_glib(),
                    current_size,
                    num_dirs,
    ...
    let res = imp.measure_disk_usage(
        from_glib(flags),
        cancellable.as_ref(),
        progress_callback.map(|callback| callback as Box<dyn FnMut(bool, u64, u64, u64)>),
    );
    match res {

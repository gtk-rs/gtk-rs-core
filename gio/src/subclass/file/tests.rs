...
use super::*;
use crate::{prelude::*, FileMonitorEvent, FileType};

mod imp {
    use super::*;
    use crate::{subclass::prelude::*, FileAttributeInfoFlags, FileAttributeType};
    ...
    impl FileImpl for MyFile {
        ...
        fn enumerate_children(
            ...
            _cancellable: Option<&impl IsA<Cancellable>>,
        ...
        fn set_display_name(
            &self,
            display_name: &str,
            _query_writable_namespaces_async: Option<&impl IsA<Cancellable>>,
        ) -> Result<File, Error> {
        ...
        fn delete(&self, _cancellable: Option<&impl IsA<Cancellable>>) -> Result<(), Error> {
        ...
        fn trash(&self, _cancellable: Option<&impl IsA<Cancellable>>) -> Result<(), Error> {
            if self.state.get() != MyFileState::Exist {
                Err(Error::new(IOErrorEnum::NotFound, "File does not exist"))
            } else {
        ...
        fn query_exists(&self, _cancellable: Option<&impl IsA<Cancellable>>) -> bool {
            true
        }
    }

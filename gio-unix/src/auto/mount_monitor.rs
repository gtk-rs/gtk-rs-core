...
glib::wrapper! {
    ...
    pub struct MountMonitor(Object<ffi::GUnixMountMonitor, ffi::GUnixMountMonitorClass>);
...
impl MountMonitor {
    ...
    pub fn connect_mountpoints_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn mountpoints_changed_trampoline<F: Fn(&MountMonitor) + 'static>(
    ...
    pub fn connect_mounts_changed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn mounts_changed_trampoline<F: Fn(&MountMonitor) + 'static>(
            this: *mut ffi::GUnixMountMonitor,
            f: glib::ffi::gpointer,
        ) {
            unsafe {
